...
import com.gac.api.adapter.in.web.dto.request.CreateReservationRequest;
...
public class ReservationController {
    ...
    private final CreateReservationInputPort createReservationUseCase;
    private final CancelReservationInputPort cancelReservationUseCase;
    private final ListOpenReservationsInputPort listOpenReservationsUseCase;

    public ReservationController(
            CreateReservationInputPort createReservationUseCase,
            CancelReservationInputPort cancelReservationUseCase,
            ListOpenReservationsInputPort listOpenReservationsUseCase) {
