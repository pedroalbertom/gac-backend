...
import com.gac.api.adapter.in.web.mapper.ProjectorMapper;
...
public class ProjectorController {
    ...
    private final CreateProjectorInputPort createProjectorUseCase;
    private final ListProjectorsInputPort listProjectorsUseCase;
    private final GetProjectorByIdInputPort getProjectorByIdUseCase;
    private final UpdateProjectorInputPort updateProjectorUseCase;
    private final DeleteProjectorInputPort deleteProjectorUseCase;

    public ProjectorController(
            CreateProjectorInputPort createProjectorUseCase,
            ListProjectorsInputPort listProjectorsUseCase,
            GetProjectorByIdInputPort getProjectorByIdUseCase,
            UpdateProjectorInputPort updateProjectorUseCase,
            DeleteProjectorInputPort deleteProjectorUseCase) {
