...
public class AssetController {
    ...
    private final SearchAssetsInputPort searchAssetsUseCase;
    private final ReleaseFromMaintenanceInputPort releaseFromMaintenanceUseCase;

    public AssetController(
            ListProjectorsInputPort listProjectorsUseCase,
            ListKeysInputPort listKeysUseCase,
            SearchAssetsInputPort searchAssetsUseCase,
            ReleaseFromMaintenanceInputPort releaseFromMaintenanceUseCase) {
