...
public class AuthController {
    ...
    private final AuthenticateUserService authenticateUserUseCase;
    private final JwtService jwtService;

    public AuthController(AuthenticateUserService authenticateUserUseCase, JwtService jwtService) {
