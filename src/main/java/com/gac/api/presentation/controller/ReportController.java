...
import com.gac.api.application.service.movement.GenerateMovementReportService;
...
public class ReportController {
    ...
    private final GenerateMovementReportService generateMovementReportUseCase;

    public ReportController(GenerateMovementReportService generateMovementReportUseCase) {
